...
- `{N, n, 0, F, FALSE, false, False}` → `FALSE`
...
The IRS e-file indicator (source `elf` 2015–2019, `efile` 2020+) uses values `E` (electronic) and `P` (paper), not `Y`/`N`. This transform maps:
