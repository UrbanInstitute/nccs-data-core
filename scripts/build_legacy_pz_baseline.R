...
#         data/crosswalks/legacy_pz_crosswalk_FINAL.csv (regenerated from OVERRIDES)
#
...
#     >= 3 distinct tax years. Columns below threshold are dropped at the
...
# Case-normalize source name for grouping; preserve a representative cased
# form (the most recent year's spelling) as `source_column`.
